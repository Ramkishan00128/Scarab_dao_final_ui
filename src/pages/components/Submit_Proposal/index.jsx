import style from "../../../styles/Submit_proposal.module.css";
        ...
        <div className={style.yellow_bg_container}>
          ...
          <div className={style.submit_panel}>
            <div className={style.stack_page_panel_data}>
              <p className={style.stack_page_panel_heading}>Submit Proposals</p>

              <div className={style.proposal_panel_data_input_align}>
                <div className={style.stack_page_balance_}>
                  <p>Name of the Guardian submitting the Proposal.</p>
                  <input className={style.input_tag} />
                </div>
                <div className={style.stack_page_balance_}>
                  <p> Guardian Discord or Twittter Handle.</p>
                  <input className={style.input_tag} />
                </div>{" "}
                <div className={style.stack_page_balance_}>
